 ...
 * in `#[PluginMetadata]`. This exercises the tested primitive — the field-level diff over
 * provides/requires/suggests (identity normalised by `ltrim('\\')`), version and name — that the
 * slice-2 `manifest drift` learnable error will be built on.
 */
